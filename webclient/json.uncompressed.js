...
;
  ...
  json.invertComponent = function(c) {
    ...
    if (c.lsr !== void 0) c_.lsl = c.lsr;
    if (c.lsl !== void 0) c_.lsr = c.lsl;
  ...
  json.apply = function(snapshot, op) {
    var c, container, e, elem, i, key, p, parent, parentkey, _i, _len, _len2, _op, _ref;
    ...
    try {
      for (i = 0, _len = op.length; i < _len; i++) {
        ...
        } else if (c.lsr !== void 0) {
          elem = elem[key];
          json.checkList(elem);
          elem.pop();
          elem.splice(0, 0, c.lsr);
        } else if (c.lsl !== void 0) {
          elem = elem[key];
          json.checkList(elem);
          elem.splice(0, 1);
          elem.push(c.lsl);
  ...
  SubDoc = (function() {
    ...
    SubDoc.prototype.pop = function(cb) {
      return this.doc.popAt(this.path, cb);
    };

    SubDoc.prototype.shiftLeft = function(value, cb) {
      return this.doc.shiftLeftAt(this.path, value, cb);
    };

    SubDoc.prototype.shiftRight = function(value, cb) {
      return this.doc.shiftRightAt(this.path, value, cb);
    };
  ...
  json.api = {
    ...
    shiftLeftAt: function(path, value, cb) {
      var elem, key, op, _ref;
      _ref = traverse(this.snapshot, path), elem = _ref.elem, key = _ref.key;
      op = {
        p: path
      };
      if (elem[key].constructor === Array) op.lsl = value;
      return this.submitOp([op], cb);
    },
    popAt: function(path, cb) {
      var op;
      op = {
        p: path
      };
    ...
    shiftRightAt: function(path, value, cb) {
      var dop, elem, iop, key, _ref;
      _ref = traverse(this.snapshot, path), elem = _ref.elem, key = _ref.key;
      iop = {
        p: path.concat(0)
      };
      iop.li = value;
      dop = {
        p: path.concat(elem[key].length - 1)
      };
      dop.ld = null;
      return this.submitOp([iop, dop], cb);
    },
